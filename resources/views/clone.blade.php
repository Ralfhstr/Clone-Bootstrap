...
<head>
    ...
    <!-- Pembuatan tag yang berisikan code untuk digunakan menghubungkan file bootstrap melalui CDN -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.6.0/font/bootstrap-icons.css">
    @vite('resources/sass/app.scss')
</head>
<body>
    <!-- Pembuatan navbar dengan posisi tetap pada halaman -->
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        <!-- Pembuatan wadah yang diberi jarak antara container yaitu py-2(padding atas bawah) dan px(padding kiri kanan) -->
        <div class="container py-2 px-4">
            <!-- Menambahkan gambar untuk logo di navbar dengan pemanggilan file yang berada di resources menggunakan vite::asset -->
                <a href="#" class="navbar-brand mb-0 h1">
                    <!-- Menambahkan gambar dengan pemanggilan file yang berada di resources menggunakan vite::asset -->
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <!-- Membuat beberapa menu di navbar dengan style col-6 col-md-auto(untuk menentukan lebar kolom) -->
    ...
    <!-- Pembuatan isi konten dengan style mt-5(untuk menambahkan margin atas sebesar 5) -->
    <div class="bg-light mt-5" id="main">
        <!-- Container -->
        <div class="container py-5 px-4">
            <div class="row">
                <!-- penggunaan style col-md-5(satuan grid layout yang digunakan membagi halaman menjadi 5 kolom dengan lebar medium) -->
                <!-- penggunaan style order-md-2(dignakan untuk mengatur urutan tampilan element di grid layout) -->
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the <a href="#"> official Bootstrap Themes marketplace</a>.
                    ...
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Browse Bootstrap Themes <i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <!-- Menambahkan gambar dengan pemanggilan file yang berada di resources menggunakan vite::asset -->
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in world by the <a href="#" class="text-black">Bootstrap team</a> with the help of <a href="#" class="text-black">our contributors</a>.</small>
                    </div>
                    <div class="mt-2 text-muted">
